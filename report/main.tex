...
低损失区域。这个结论与文献中的认识一致：BN 最初被解释为减轻 internal covariate
shift \cite{ioffe2015batch}，但更现代的解释强调其对优化景观的平滑作用
\cite{santurkar2018batch}；本项目的结果更直接支持后者，即 BN 改善了优化条件和学习率
鲁棒性。
...
loss landscape 分析。Part 1 best checkpoint 达到 \bestPartOneAcc{}，消融实验最高观察精度为
